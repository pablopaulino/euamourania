...
const [api, admin, css, access, migration, docs, pkgText] = await Promise.all([
  read("api/newsletter-monthly.js"),
...
must(!api.includes("BREVO_API_KEY"), "Gerador mensal não deve acessar chave Brevo nem enviar e-mail.");

must(admin.includes("/api/newsletter-monthly"), "Painel não chama o gerador mensal.");
