...
must(migration.includes("melhores_validar_limite_indicados"), "Migração deve validar limite de indicados no banco");
must(migration.includes("limite_indicados set default 4"), "Migração deve definir quatro indicados como padrão");
