...
for(const feature of["renderTourism","turismo:renderizado","normalize(","fetchPublicRows(\"turismo\""])must(js.includes(feature),`Turismo sem comportamento: ${feature}`);
must(!html.includes("data-tourism-filter")&&!js.includes("data-tourism-filter"),"Turismo deve ficar sem abas de categoria/filtro visual");
