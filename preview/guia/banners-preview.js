...
function insertAdSenseInsideArticle() {
  ...
  if (!article) return;
  if (article.dataset.adEligible === "false") return;
...
function zoneMarkup(position, items, inline = false) {
  ...
  const controls = slides.length > 1
    ? `<div class="ad-rotator-controls"><div class="ad-rotator-dots">${slides.map((_, index) => `<button type="button" data-ad-index="${index}" class="${index === 0 ? "active" : ""}" aria-label="Ver anúncio ${index + 1}"></button>`).join("")}</div></div>`
    : "";
...
function insertGlobalZone() {
  if (["/preview/noticias/materia/", "/preview/noticias/materia/index.html", "/preview/agenda/", "/preview/agenda/index.html", "/preview/agenda/evento/", "/preview/agenda/evento/index.html", "/preview/agenda/tradicao/", "/preview/agenda/tradicao/index.html", "/preview/agenda/edicao/", "/preview/agenda/edicao/index.html"].includes(location.pathname)) return false;
...
function render() {
  ...
  if (path === "/preview/links/" || path === "/preview/links/index.html") {
    const footer = document.querySelector(".links-preview-shell > footer");
    if (footer && !insertZone("todas_paginas", footer, "beforebegin")) {
      insertZone("home_rodape", footer, "beforebegin");
    }
  }
  ...
  if (/\/news\/?(?:index\.html)?$/.test(path) || path.endsWith("news.html") || path === "/preview/noticias/" || path === "/preview/noticias/index.html") {
  ...
  if (path === "/preview/noticias/materia/" || path === "/preview/noticias/materia/index.html") {
    insertZone("noticia_final", ".site-footer");
  }
  if (path.endsWith("guia.html") || path === "/preview/guia/" || path === "/preview/guia/index.html") {
    insertRepeatedBetweenCards("guia_entre_estabelecimentos", "#guia-container", ".card-guia", 6);
    insertZone("guia_rodape", ".site-footer");
  }
  if (path === "/preview/guia/empresa/" || path === "/preview/guia/empresa/index.html") {
    insertZone("guia_rodape", "#detail-final-ad-anchor", "beforebegin");
  }
  if (path === "/preview/turismo/local/" || path === "/preview/turismo/local/index.html") {
    insertZone("turismo_rodape", "#tourism-detail-ad-anchor", "beforebegin");
  }
  ...
  if (path.endsWith("turismo.html") || path === "/preview/turismo/" || path === "/preview/turismo/index.html") {
    insertRepeatedBetweenCards("turismo_entre_cartoes", "#turismo-container", ".card-guia", 6, true);
    if (!path.startsWith("/preview/turismo")) insertZone("turismo_rodape", ".site-footer");
  }
  ...
  if (path === "/preview/agenda/" || path === "/preview/agenda/index.html") {
    insertZone("eventos_rodape", "#agenda-ad-anchor", "beforebegin");
  }
  if (path === "/preview/agenda/evento/" || path === "/preview/agenda/evento/index.html") {
    insertZone("eventos_rodape", "#agenda-event-ad-anchor", "beforebegin");
  }
  if (path === "/preview/agenda/tradicao/" || path === "/preview/agenda/tradicao/index.html") {
    insertZone("eventos_rodape", "#agenda-tradition-ad-anchor", "beforebegin");
  }
  if (path === "/preview/agenda/edicao/" || path === "/preview/agenda/edicao/index.html") {
    insertZone("eventos_rodape", "#agenda-edition-ad-anchor", "beforebegin");
  }
...
document.addEventListener("noticia:renderizada", () => {
  if (location.pathname === "/preview/noticias/materia/" || location.pathname === "/preview/noticias/materia/index.html") insertZone("noticia_final", ".site-footer");
});
...
function renderAdSense() {
  ...
  if (path === "/preview/noticias/materia/" || path === "/preview/noticias/materia/index.html") {
    insertAdSenseZone("noticia_final", adsense.slots.finalRodape, ".site-footer");
  }
  if (path.endsWith("guia.html") || path === "/preview/guia/" || path === "/preview/guia/index.html") {
  ...
  if (path === "/preview/guia/empresa/" || path === "/preview/guia/empresa/index.html") {
    insertAdSenseZone("guia_rodape", adsense.slots.finalRodape, "#detail-final-ad-anchor", "beforebegin");
  }
  if (path === "/preview/turismo/local/" || path === "/preview/turismo/local/index.html") {
    insertAdSenseZone("turismo_rodape", adsense.slots.finalRodape, "#tourism-detail-ad-anchor", "beforebegin");
  }
  if (path.endsWith("turismo.html") || path === "/preview/turismo/" || path === "/preview/turismo/index.html") {
    insertAdSenseBetweenCards("turismo_entre_cartoes", adsense.slots.listagens, "#turismo-container", ".card-guia", 6);
    if (!path.startsWith("/preview/turismo")) insertAdSenseZone("turismo_rodape", adsense.slots.finalRodape, ".site-footer");
  }
  if (path.includes("/eventos")) {
  ...
  if (path === "/preview/agenda/" || path === "/preview/agenda/index.html") {
    insertAdSenseZone("eventos_rodape", adsense.slots.finalRodape, "#agenda-ad-anchor", "beforebegin");
  }
  if (path === "/preview/agenda/evento/" || path === "/preview/agenda/evento/index.html") {
    insertAdSenseZone("eventos_rodape", adsense.slots.finalRodape, "#agenda-event-ad-anchor", "beforebegin");
  }
  if (path === "/preview/agenda/tradicao/" || path === "/preview/agenda/tradicao/index.html") {
    insertAdSenseZone("eventos_rodape", adsense.slots.finalRodape, "#agenda-tradition-ad-anchor", "beforebegin");
  }
  if (path === "/preview/agenda/edicao/" || path === "/preview/agenda/edicao/index.html") {
    insertAdSenseZone("eventos_rodape", adsense.slots.finalRodape, "#agenda-edition-ad-anchor", "beforebegin");
  }
}
