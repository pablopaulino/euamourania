...
const viewModules={dashboard:"dashboard",noticias:"noticias",colaboradores_voluntarios:"colaboradores",guia_comercial:"guia_comercial",guia_verificacao:"guia_comercial",turismo:"turismo",turismo_verificacao:"turismo",telefones_uteis:"configuracoes",motoristas:"configuracoes",iniciativas:"configuracoes",links:"links",eventos:"eventos",eventos_principais:"eventos",eventos_edicoes:"eventos",categorias:"categorias",insights:"insights",audiencia:"insights",configuracoes_site:"configuracoes",comunicacao:"comunicacao",notificacoes:"notificacoes",submissoes:"submissoes",publicidade:"publicidade",usuarios:"usuarios",importacao:"importacao",melhores:"melhores"};
const navItems=[
  ...
  ["motoristas","Motoristas","configuracoes"],
  ["iniciativas","Iniciativas da Comunidade","configuracoes"],
  ["links","Links","links"],
...
function buttonForNav([key,label,module],isIndex,current){
  ...
  if(isIndex){
    if(["dashboard","noticias","colaboradores_voluntarios","guia_comercial","guia_verificacao","turismo","turismo_verificacao","telefones_uteis","motoristas","iniciativas","links","eventos","eventos_principais","eventos_edicoes","categorias","configuracoes_site","comunicacao","notificacoes","submissoes","publicidade","usuarios","importacao","melhores"].includes(key))attrs.push(`data-view="${key}"`);
