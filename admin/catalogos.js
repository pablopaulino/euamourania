...
function listing() {
  return `<header class="admin-page-header"><div><h2>Catálogos</h2><p>Produtos e opções das empresas do Guia. Área administrativa, ainda sem exibição pública.</p></div><div class="catalog-actions">${can('criar')?button('new','Criar catálogo')+button('import','Importar JSON'):''}</div></header>
