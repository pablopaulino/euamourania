...
export const ADMIN_MODULE_ICONS = {
  ...
  spark: icon(`<path d="m12 3 1.5 5.1L18.5 10l-5 1.8L12 17l-1.5-5.2-5-1.8 5-1.9L12 3Z"/><path d="m18.5 15 .7 2.3 2.3.7-2.3.8-.7 2.2-.8-2.2-2.2-.8 2.2-.7.8-2.3Z"/>`),
...
export const ADMIN_MODULES = {
  ...
  catalogos: { label: "Catálogos", description: "Catálogos, categorias, produtos, variações e adicionais das empresas.", route: "/admin/catalogos", group: "Viva Urânia", icon: "editions", keywords: ["produtos", "cardápios", "catálogos"], permission: "guia_comercial", dashboard: { domain: "Viva Urânia", indicator: "Catálogos" } },
  ...
  sugestoes_momento: { label: "Sugestões do momento", description: "Agenda editorial e recorrente da vitrine principal da Home do Viva.", route: "/admin/sugestoes-momento", group: "Viva Urânia", icon: "spark", keywords: ["home", "agenda", "destaque", "vitrine"], primaryAction: "Nova sugestão", permission: "configuracoes", dashboard: { domain: "Viva Urânia", indicator: "Agendadas" } },
