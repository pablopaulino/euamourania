...
export const ADMIN_MODULES = {
  ...
  publicidade: { label: "Publicidade", description: "Campanhas, assinantes, posições, mídia e métricas comerciais.", route: "/admin/publicidade", group: "Comercial", icon: "ads", keywords: ["anúncios", "comercial", "assinantes"], primaryAction: "Nova publicidade", permission: "publicidade", dashboard: { domain: "Comercial", indicator: "Campanhas" } },
  melhores: { label: "Melhores de Urânia", description: "Edições, categorias, indicados, votos e apuração.", route: "/admin/melhores", group: "Comercial", icon: "award", keywords: ["prêmio", "votação", "melhores"], permission: "melhores", dashboard: { domain: "Comercial", indicator: "Edições" } },
  comunicacao: { label: "Comunicação", description: "Newsletters, assinantes, disparos e relacionamento.", route: "/admin/comunicacao", group: "Comunicação", icon: "mail", keywords: ["email", "newsletter"], permission: "comunicacao", dashboard: { domain: "Comunicação", indicator: "Assinantes" } },
  notificacoes: { label: "Notificações do app", description: "Push, aparelhos cadastrados e histórico do Viva Urânia.", route: "/admin/viva-urania", group: "Comunicação", icon: "bell", keywords: ["push", "app", "viva"], permission: "notificacoes", dashboard: { domain: "Comunicação", indicator: "Envios" } },
  ...
  usuarios: { label: "Usuários", description: "Equipe administrativa, papéis e permissões.", route: "/admin/usuarios", group: "Sistema", icon: "people", keywords: ["admin", "permissões", "equipe"], permission: "usuarios", dashboard: { domain: "Sistema", indicator: "Ativos" } },
