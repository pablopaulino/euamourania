...
const permissoesPorFuncao={
  super_admin:["*:*"] ,
  administrador:["dashboard:acessar","insights:acessar","insights:ler","noticias:*","colaboradores:*","categorias:*","guia_comercial:*","turismo:*","eventos:*","submissoes:*","publicidade:*","comunicacao:*","notificacoes:*","melhores:*","links:*"],
  ...
  comercial:["dashboard:acessar","guia_comercial:acessar","guia_comercial:ler","guia_comercial:criar","guia_comercial:editar","submissoes:*","publicidade:acessar","publicidade:ler","publicidade:criar","publicidade:editar","melhores:acessar","melhores:ler"],
