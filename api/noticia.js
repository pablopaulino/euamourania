...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const structured = JSON.stringify({
      ...
      author: { "@type": "Organization", name: noticia.autor || publisher },
      publisher: {
        "@type": "Organization",
        name: publisher,
