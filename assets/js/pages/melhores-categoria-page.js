...
async function init() {
  ...
  document.querySelector('meta[name="description"]')?.setAttribute("content", (category.descricao || `Indicados da categoria ${category.nome}.`).slice(0, 155));
  document.querySelector('link[rel="canonical"]')?.setAttribute("href", canonical);
  document.querySelector('meta[property="og:title"]')?.setAttribute("content", `${category.nome} | Melhores de Urânia`);
  document.querySelector('meta[property="og:description"]')?.setAttribute("content", (category.descricao || "Conheça os indicados desta categoria.").slice(0, 155));
