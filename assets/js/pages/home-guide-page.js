...
function addStyle() {
  ...
  style.textContent = `
    ...
    .home-guide-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.75rem}
    .home-guide-card{position:relative;display:grid;grid-template-columns:62px minmax(0,1fr) 28px;gap:.78rem;align-items:center;min-height:84px;padding:.62rem .72rem;color:inherit;background:#fff;border:1px solid rgba(7,59,76,.1);border-radius:19px;box-shadow:0 10px 26px rgba(7,59,76,.055);text-decoration:none;transition:transform .18s ease,box-shadow .18s ease,border-color .18s ease}
    ...
    .home-guide-media{display:grid;width:62px;height:62px;place-items:center;overflow:hidden;color:var(--blue);background:linear-gradient(135deg,#eef8fa,#fff4cf);border-radius:15px;font-size:.58rem;font-weight:900;text-align:center}
    .home-guide-media img{width:100%;height:100%;object-fit:cover}
    .home-guide-card small{display:block;margin-bottom:.18rem;overflow:hidden;color:var(--blue);font-size:.62rem;font-weight:900;letter-spacing:.06em;text-overflow:ellipsis;text-transform:uppercase;white-space:nowrap}
    .home-guide-card h3{display:-webkit-box;overflow:hidden;margin:0;color:var(--navy);font-size:1rem;line-height:1.14;-webkit-line-clamp:2;-webkit-box-orient:vertical}
    .home-guide-arrow,.home-guide-badge{display:grid;width:26px;height:26px;place-items:center;justify-self:end;border-radius:999px;font-weight:900}
    ...
    @media(max-width:720px){.home-guide{padding:2.25rem 0}.home-guide-head{display:grid;margin-bottom:1rem}.home-guide-head h2{font-size:1.9rem}.home-guide-link{justify-self:start}.home-guide-grid{grid-template-columns:1fr;gap:.62rem}.home-guide-card{grid-template-columns:58px minmax(0,1fr) 24px;min-height:78px;padding:.55rem .62rem;border-radius:17px}.home-guide-media{width:58px;height:58px;border-radius:14px}.home-guide-card h3{font-size:.98rem}.home-guide-arrow,.home-guide-badge{width:24px;height:24px}.home-collab-box{grid-template-columns:1fr;padding:.95rem;border-radius:20px}.home-collab-box .button{width:100%;justify-content:center}}
  `;
...
async function init() {
  ...
  const items = await fetchPublicRows("guia_comercial", {
    select: "id,nome,slug,categoria_nome,imagem_url,recomendado",
    status: "eq.publicado",
