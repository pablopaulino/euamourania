...
document.addEventListener("click",event=>{
 ...
 selectedCategory="";search.value="";visibleCount=PAGE_SIZE;
 filters.querySelectorAll("[data-category]").forEach(item=>{const active=!item.dataset.category;item.classList.toggle("active",active);item.setAttribute("aria-pressed",String(active))});
 renderFeed();search.focus();
});
